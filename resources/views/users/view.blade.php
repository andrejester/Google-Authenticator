                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form class="needs-validation" novalidate action="{{ route('users.update', $users->id_user) }}"
                                method="POST">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name"
                                                    ...
                                                    placeholder="Name User" value="{{ old('name', $users->name) }}"
                                                    required>
                                                @error('name')
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="email" name="email"
                                                    ...
                                                    placeholder="Email" value="{{ old('email', $users->email) }}" required>
                                                @error('email')
                                                    <span class="invalid-feedback text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
